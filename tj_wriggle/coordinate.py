class Coordinate:
    def __init__(self, x, y):
        ...
        Where a coordinate with members x and y are interpreted as x positions 
        *down* (height) and y positions *right* (width) in the context of the 
        TJ-Wriggler puzzle grid.
        """
        self.x = x
        self.y = y
